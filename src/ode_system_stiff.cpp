...
// [[Rcpp::export]]
SEXP
ode_system_stiff_class__get_pars(Rcpp::XPtr<rodeint::ode_system_stiff_class> ode_system) {
  return rodeint::ode_system__get_pars<rodeint::ode_system_stiff_class>(ode_system);
}

// [[Rcpp::export]]
void
ode_system_stiff_class__set_pars(Rcpp::XPtr<rodeint::ode_system_stiff_class> ode_system,
                       SEXP pars) {
...
ode_system_stiff_class__derivs(Rcpp::XPtr<rodeint::ode_system_stiff_class> ode_system,
...
ode_system_stiff_class__jacobian(Rcpp::XPtr<rodeint::ode_system_stiff_class> ode_system,
                             rodeint::ode_system_stiff_class::state_type y,
                             double t) {
