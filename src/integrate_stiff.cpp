...
integrate_const_stiff_${type}(rodeint::stepper s,
                        rodeint::ode_system_stiff_${type} ode_system,
                        rodeint::ode_system_stiff_${type}::state_type y,
                        double t0, double t1, double dt,
                        bool save_state) {
  return rodeint::r_integrate_const_stiff(s, ode_system, y,
                                          t0, t1, dt, save_state);
}
"""
...
integrate_n_steps_stiff_${type}(rodeint::stepper s,
  ...
  return rodeint::r_integrate_n_steps_stiff(s, ode_system, y,
                                            t0, dt, nu, save_state);
}
"""
for t in system_types:
...
integrate_adaptive_stiff_${type}(rodeint::stepper s,
                           ...
                           double t0, double t1, double dt,
                           bool save_state) {
  return rodeint::r_integrate_adaptive_stiff(s, ode_system, y,
                                             t0, t1, dt, save_state);
}
"""
for t in system_types:
...
integrate_times_stiff_${type}(rodeint::stepper s,
  ...
  return rodeint::r_integrate_times_stiff(s, ode_system, y,
                                          times, dt);
}
"""
for t in system_types:
