...
integrate_adaptive_stiff_r <- function(stepper, ode_system, y, t0, t1, dt, save_state) {
    .Call('rodeint_integrate_adaptive_stiff_r', PACKAGE = 'rodeint', stepper, ode_system, y, t0, t1, dt, save_state)
}

integrate_adaptive_stiff_cpp <- function(stepper, ode_system, y, t0, t1, dt, save_state) {
    .Call('rodeint_integrate_adaptive_stiff_cpp', PACKAGE = 'rodeint', stepper, ode_system, y, t0, t1, dt, save_state)
}

integrate_adaptive_stiff_class <- function(stepper, ode_system, y, t0, t1, dt, save_state) {
    .Call('rodeint_integrate_adaptive_stiff_class', PACKAGE = 'rodeint', stepper, ode_system, y, t0, t1, dt, save_state)
}
