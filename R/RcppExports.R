...
r_integrate_stiff_adaptive_r <- function(ode_system, y, t0, t1, dt, save_state) {
    .Call('rodeint_r_integrate_stiff_adaptive_r', PACKAGE = 'rodeint', ode_system, y, t0, t1, dt, save_state)
}

r_integrate_stiff_adaptive_cpp <- function(ode_system, y, t0, t1, dt, save_state) {
    .Call('rodeint_r_integrate_stiff_adaptive_cpp', PACKAGE = 'rodeint', ode_system, y, t0, t1, dt, save_state)
}

r_integrate_stiff_adaptive_class <- function(ode_system, y, t0, t1, dt, save_state) {
    .Call('rodeint_r_integrate_stiff_adaptive_class', PACKAGE = 'rodeint', ode_system, y, t0, t1, dt, save_state)
}
