...
test_that("Argument handling for errored input", {
  ...
  ## we're talking about.
  expect_that(integrate_const(s, target, y0, t0, t1, stats::dt),
  ...
  expect_that(integrate_const(s, target, y0, 0L, t1, dt),
              is_identical_to(integrate_const(s, target, y0, 0.0, t1, dt)))
  expect_that(integrate_const(s, target, y0, t0, 1L, dt),
              is_identical_to(integrate_const(s, target, y0, t0, 1L, dt)))
  expect_that(integrate_const(s, target, y0, t0, t1, 1L),
              is_identical_to(integrate_const(s, target, y0, t0, t1, 1L)))
})
