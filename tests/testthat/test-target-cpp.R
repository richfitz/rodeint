...
test_that("construction", {
  pars <- 0.5
  obj <- target(rodeint:::test_harmonic_oscillator_cpp, pars)
  expect_that(obj, is_a("target"))
  expect_that(obj$type, is_identical_to("target_cpp"))
...
test_that("construction from deSolve type", {
  ...
  expect_that(target(rodeint:::test_harmonic_oscillator_cpp, pars, TRUE),
